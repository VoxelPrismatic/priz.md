...
"word", "LiquidCrytal"]
;var c_ext__ = ["extern","import", "module", "export"]
;var c_set__ = ["const", "struct", "static", "typedef", "volatile", "inline", "restrict",
...
;var c_kw__ = ["auto", "break", "case", "continue", "default", "do", "else",  "for", "goto",
...
...std_escape__,
[/^([\u200b ]*)\#([ \w]+)(.*)\n/gm,
`$1<span class="kw">#$2</span> <span class="op">$3</span><br>`], [/([\u200b ]*)(class|implements|extends) ([\w\d_]+)/gm,
