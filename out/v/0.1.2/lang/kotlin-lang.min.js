...
;var kotlin_ext__ = ["package", "import"]
;var kotlin_set__ = ["fun", "val", "var", "object", "public", "protected", "private", "internal",
...
;var kotlin_kw__ = ["return", "if", "else", "is", "in", "for", "while", "when", "try", "catch",
...
"out", "vararg", "it"]
;function kotlin_str_regex__(m, b, c) {var st = "";if(b[0] == '"') {var incode = false;for(var d of c.split('')) {if(d == "${") {st += "</span>${";incode = true;}
...
var kotlin_regex__ = [[/(")(.*?[^\\\n]|)"/gm,
kotlin_str_regex__], [/(')(\\?.?)'/gm,
kotlin_str_regex__], [/(""")((.|\n)*?)"""/gm,
kotlin_str_regex__],
...std_escape__,
[/\\u\{([A-Fa-f0-9\u200b]+\})/gm,
`<span class="op">\\u$1</span>`], [/([\u200b ]*)(class|implements|extends|interface) ([\w\d_]+)/gm,
