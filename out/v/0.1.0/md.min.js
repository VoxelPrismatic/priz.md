...
try {sub_styles();}
catch(err) {function sub_styles() {console.group("Reformatting page");if(find(">table")) {console.log("Styling tables")
...
return st;}
function load_script(src) {globalThis.src__ = src;console.info(`Dynamically loading '${src__}'`);fetch(src).then(resp => resp.text().then(code => {globalThis.eval(code);console.info(`Finished loading '${src__}'`);}));}
