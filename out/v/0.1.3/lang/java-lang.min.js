...
"Long", "Short", "HashMap", "Object", "null", "super", "this"];var java_ext__ = ["package", "import"];var java_set__ = ["private", "protected", "public", "synchronized","class", "const", "extends",
"final", "abstract", "native", "new", "static", "strictfp", "transient",
"implements"];var java_kw__ = ["assert", "break", "case", "catch", "continue", "default", "do", "else", "enum",
"finally", "for", "goto", "if", "instanceof", "return", "switch", "throw", "throws",
"try", "while", "true", "false"];function java_str_regex__(m, b, c) {var st = "";st = c.split('').join("\u200b");return `<span class="str">${b}${st}${b}</span>`;}
var java_regex__ = [[/(")(.*?[^\\\n]|)"/gm,
java_str_regex__],
[/(')(\\?.?)'/gm,
java_str_regex__],
