...
;var ts_ext__ = ["export", "import", "from", "require", "module",]
;var ts_set__ = ["let", "enum", "function", "new", "declare", "var", "const", "class", "interface",
"readonly", "implements", "extends", "constructor", "public", "private", "protected",
"get", "set", "abstract", "=>", "type", "namespace",]
;var ts_kw__ = ["throw", "while", "return", "for", "if", "catch", "try", "keyof", "typeof",
"is", "in", "instanceof", "switch", "case", "default", "of", "as",]
;function ts_str_regex__(m, b, c) {var st = "";if(b == "`") {var incode = false;for(var d of c.split('')) {if(d == "${") {st += "</span>${";incode = true;}
