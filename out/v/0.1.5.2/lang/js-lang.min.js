...
var js_cls__ = ["ArrayBuffer", "Array", "AsyncFunction", "AsyncIterator", "Intl.DateTimeFormat",
...
"true", "false", "Set", "char", "double", "byte", "float", "long"];var js_ext__ = ["import", "import.meta", "label", "from", "export", "block", "empty",
"require", "exports", "module"];var js_set__ = ["function", "function\\*", "var", "new", "let", "extends", "const", "private",
"protected", "public", "globalThis", "implements", "delete", "constructor",
"get", "set", "=>", "class", "native"];var js_kw__ = ["async", "break", "continue", "debugger", "default", "do", "while", "for",
"of", "if", "else", "return", "throw", "try", "catch", "with", "in",
"instanceof", "typeof", "yield", "yield\\*", "await", "finally",];function js_str_regex__(m, b, c) {var st = "";if(b == "`") {var incode = false;for(var d of c.split('')) {if(d == "${") {st += "</span>${";incode = true;}
