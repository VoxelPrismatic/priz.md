...
"xcopy"]
;var cmd_ext__ = ["append", "arp", "assoc", "at", "atmadm", "attrib", "auditpol", "autochk", "autoconv",
...
;function cmd_str_regex__(m, b, c) {var st = "";var incode = false;for(var d of c.split('')) {if(d == "%" && !incode) {st += "</span>%";incode = true;}
