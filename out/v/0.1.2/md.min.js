...
try {sub_styles();}
catch(err) {function sub_styles() {console.groupCollapsed("Reformatting page");if(find(">table")) {console.log("Styling tables")
var styleTables = styleTables || undefined;logFunc(styleTables);}
if(find(".accent")) {console.log("Moving accents")
...
[/(.*)\:\^\:(.*)/gm,
"<div style='height: 24px;'><align-left>$1</align-left><div class='dict'></div><align-right>$2</align-right></div></br>"],
