...
"map", "object", "quit", "id", "super", "self"];var py_ext__ = ["import", "from", "reload"];var py_set__ = ["def", "class", "del", "nonlocal", "global", "local"];var py_kw__ = ["yield", "break", "if", "assert", "finally", "elif", "else", "for", "while",
"with", "as", "in", "not", "and", "or", "is", "try", "except", "pass", "continue",
"break", "return", "lambda", "issubclass", "isinstance", "next"];function py_str_regex__(m, a, b, c) {var st = "";if(a == "f" || a == "F") {var incode = false;for(var d of c.split('')) {if(d == "{") {st += "</span>{";incode = true;}
